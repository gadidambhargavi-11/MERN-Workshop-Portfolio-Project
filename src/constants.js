...
export const COLORS = {
  // Light Mode Colors
  light: {
    primary: "#C63EEF", // Emerald green
    secondary: "#8868F3", // Amber
    accent: "#ec4899", // Pink
    background: "#FADFBD",
    surface: "#62a6eaff",
    text: "#111827",
...
export const PERSONAL_INFO = {
  ...
  email: "gadidambhargavi@gmail.com",
  phone: "9392749312",
  location: "banglore",

  // Social Media Links
  social: {
    github: "https://github.com/gadidambhargavi-11",
    linkedin: "https://linkedin.com/in/bhargavi-gadidam-2b4a7a356",
